          ...
          {["name", "email", "department", "role"].map((field) => (
            <div key={field}>
              ...
              <input
                ...
                className={`w-full mt-1 px-3 py-2 bg-white/10 border border-white/20 rounded ${(!isEdit || field === "email" || field === "department" || field === "role") ? 'opacity-60 cursor-not-allowed' : 'focus:ring-2 focus:ring-blue-500 text-white'}`}
              />
            </div>
          ))}
        </div>
